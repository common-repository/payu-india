...
4. screenshot-4: Return Page in case of error occured.
5. screenshot-5: Checkout page showing PayU as payment option.
6. screenshot-6: Billing/Shipping details validation error.
7. screenshot-7: PayU payment page for making payment.
8. screenshot-8: Payment error posted back by PayU payment gateway.
9. screenshot-9: After successful payment, control redirected to WooCommerce order success page.
